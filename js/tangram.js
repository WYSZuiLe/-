window._bd_share_main.F.module("base/tangram",
function(e, t) {
    var n, r = n = function() {
        var e, t = e = t ||
        function(e, n) {
        ...
        t.forEach = function(e, t, n) {
            ...
            if (typeof t == "function" && e) {
                ...
                if (typeof i == "number") {
                    ...
                    t.call(n || null, s, r, e)
                } else if (typeof e == "number") for (r = 0; r < e; r++) t.call(n || null, r, r, r);
                else if (typeof e == "object") for (r in e) e.hasOwnProperty(r) && t.call(n || null, e[r], r, e)
            }
            return e
        },
        t.type = function() {
        ...
        t.extend = function(e, n) {
            ...
            for (; a < f; a++) {
                ...
                if (t.isObject(i)) for (s in i) {
                    ...
                    u = i[s];
                    if (o === u) continue;
                    t.isBoolean(e) && e && u && (t.isPlainObject(u) || (c = t.isArray(u))) ? (c ? (c = !1, h = o && t.isArray(o) ? o: []) : h = o && t.isPlainObject(o) ? o: {},
        ...
        t.createChain("string",
        function(e) {
            var n = t.type(e),
            r = new String(~"string|number".indexOf(n) ? e: n),
            i = String.prototype;
            return t.forEach(t.string.$String.prototype,
            function(e, t) {
                i[t] || (r[t] = e)
            }),
            r
        ...
        t.overwrite(t.array.$Array, "concat slice".split(" "),
        function(e) {
            return function() {
        ...
        t.array.extend({
            indexOf: function(e, n) {
                ...
                var r = this.length; (n |= 0) < 0 && (n = Math.max(0, r + n));
                for (; n < r; n++) if (n in this && this[n] === e) return n;
                return - 1
            }
        }),
        t.createChain("Callbacks",
        function(e) {
            var n = e;
        ...
        function(e) {
            ...
            c = {
                ...
                remove: function() {
                    if (!r) return this;
                    var e;
                    return t.forEach(arguments,
                    function(n) {
                        while ((e = t.array(r).indexOf(n)) > -1) r.splice(e, 1),
                        f && e < s && s--
                    }),
                    this
                },
        ...
        function() {
            ...
            return function(e, t, r) {
                return typeof t != "undefined" ? (r || (t = typeof n[e] == "undefined" ? t: n[e]), n[e] = t) : e && typeof n[e] == "undefined" && (n[e] = {}),
                n[e]
            }
        } (),
        t.browser = t.browser ||
        function() {
            ...
            case / opera( ? :\ / |)(\d + ( ? :\.\d + ) ? )(. + ?(version\ / (\d + ( ? :\.\d + ) ? ))) ? /i.test(e):n.opera=+(RegExp.$4||RegExp.$1)}return t.extend(t,n),n}(),t.id=function(){var e=t.global("_maps_id"),n=t.key;return window[t.guid]._counter=window[t.guid]._counter||1,function(r,i){var s,o=t.isString(r),u=t.isObject(r),a=u?r[n]:o?r:"";if(t.isString(i))switch(i){case"get":return u?a:e[a];case"remove":case"delete":if(s=e[a])t.isElement(s)&&t.browser.ie<8?s.removeAttribute(n):delete s[n],delete e[a];return a;default:return o?((s=e[a])&&delete e[a],s&&(e[s[n]=i]=s)):u&&(a&&delete e[a],e[r[n]=i]=r),i}return u?(!a&&(e[r[n]=a=t.id()]=r),a):o?e[r]:"TANGRAM_"+t._global_._counter++}}(),t._util_=t._util_||{},t._util_.support=t._util_.support||function(){var e=document.createElement("div"),t,n,r,i,s;return e.setAttribute("className","t"),e.innerHTML=' <link/ > <table > </table><a href="/a ">a</a><input type="checkbox "/>',n=e.getElementsByTagName("A ")[0],n.style.cssText="top: 1px;
                ...
                function(e, n) {
                    function H(e, t, n, r) {
                        ...
                        n && (f = T(o, D, n));
                        if (e >= 200 && e < 300 || e === 304) o.ifModified && (c = D.getResponseHeader("Last-Modified"), c && (g[h] = c), c = D.getResponseHeader("Etag"), c && (y[h] = c)),
                        e === 304 ? (i = "notmodified", s = !0) : (s = N(o, f), i = s.state, u = s.data, a = s.error, s = !a);
                        else {
                            a = i;
                            if (!i || e) i = "error",
                            e < 0 && (e = 0)
                    ...
                    t.object.isPlain(e) && (n = e, e = undefined),
                    n = n || {};
                    var o = t.ajax.setup({},
                    n),
                    l = o.context || o,
                    ...
                    M,
                    _,
                    D = t.extend(new t.ajax.$Ajax(e, o), {
                        readyState: 0,
                    ...
                    D.statusCode = function(e) {
                        if (e) if (x < 2) for (var t in e) S[t] = [S[t], e[t]];
                        else D.always(e[D.status]);
                        return this
                    },
                    o.url = ((e || o.url) + "").replace(s, "").replace(r, b[1] + "//"),
                    o.dataTypes = t.string(o.dataType || "*").trim().toLowerCase().split(/\s+/),
                    o.crossDomain == null && (p = i.exec(o.url.toLowerCase()), o.crossDomain = !(!p || p[1] == b[1] && p[2] == b[2] && (p[3] || (p[1] === "http:" ? 80 : 443)) == (b[3] || (b[1] === "http:" ? 80 : 443)))),
                    ...
                    if (!o.hasContent) {
                        o.data && (o.url += (~o.url.indexOf("?") ? "&": "?") + o.data, delete o.data),
                        h = o.url;
                        if (o.cache === !1) {
                    ...
                    o.ifModified && (h = h || o.url, g[h] && D.setRequestHeader("If-Modified-Since", g[h]), y[h] && D.setRequestHeader("If-None-Match", y[h])),
                ...
                t.ajax.setup = function(e, n) {
                    return n ? k(e, t.ajax.settings) : (n = e, e = t.ajax.settings),
                    k(e, n),
                    e
                },
                t.ajax.param = function(e, n) {
                    var r = [];
                    if (t.type(e) === "array") t.forEach(e,
                    function(e) {
                        L(r, e.name, e.value)
                    });
                    else for (var i in e) A(r, i, e[i], n);
                ...
                function(e, n, r) {
                    ...
                    if (e.dataTypes[0] === "jsonp" || l || c) return i = e.jsonpCallback = t.type(e.jsonpCallback) === "function" ? e.jsonpCallback() : e.jsonpCallback,
                    s = window[i],
                    ...
                    r.always(function() {
                        window[i] = s,
                        e[i] && (e.jsonpCallback = n.jsonpCallback, O.push(i)),
                ...
                t.ajax.prefilter("script",
                function(e) {
                    e.cache === undefined && (e.cache = !1),
                    e.crossDomain && (e.type = "GET", e.global = !1)
                }),
                t.ajax.transport("script",
                function(e) {
                    if (e.crossDomain) {
                        ...
                        return {
                            send: function(r, i) {
                                ...
                                t.onload = t.onreadystatechange = function(e, r) {
                                    if (r || !t.readyState || /loaded|complete/.test(t.readyState)) t.onload = t.onreadystatechange = null,
                ...
                var D, P = 0,
                H = window.ActiveXObject ?
                function() {
                    for (var e in D) D[e](0, 1)
                }: !1;
                t.ajax.settings.xhr = window.ActiveXObject ?
                function() {
                    ...
                    if (!e.crossDomain || t._util_.support.cors) {
                        ...
                        return {
                            send: function(r, i) {
                                ...
                                e.async ? o.readyState === 4 ? setTimeout(n, 0) : (s = ++P, H && (D || (D = {},
                                t.dom(window).on("unload", H)), D[s] = n), o.onreadystatechange = n) : n()
                            },
                            abort: function() {
                                n && n(0, 1)
                            }
            ...
            t.array.extend({
                ...
                filter: function(e, n) {
                    ...
                    o,
                    u = 0;
                    if (t.type(e) === "function") for (i = 0, s = this.length; i < s; i++) o = this[i],
                ...
                lastIndexOf: function(e, n) {
                    ...
                    var r = this.length; (!(n |= 0) || n >= r) && (n = r - 1),
                    n < 0 && (n += r);
            ...
            t.base.Class = function() {
                ...
                dispose: function() {
                    ...
                    if (this._listeners_) for (var e in this._listeners_) this._listeners_[e].length = 0,
                ...
                fire: function(e, n) {
                    ...
                    a = e.type,
                    f = [e].concat(Array.prototype.slice.call(arguments, 1)); ! u && (u = this._listeners_ = {}),
                    t.extend(e, n || {}),
                    ...
                    if (t.isArray(s = u[a])) for (r = s.length - 1; r > -1; r--) o = s[r],
                ...
                off: function(e, t) {
                    ...
                    else if (r = i[e]) for (n = r.length - 1; n >= 0; n--) r[n].handler === t && r.splice(n, 1);
                    return this
                }
            ...
            t.base.register = function(e, t, n) { (e._reg_ || (e._reg_ = [])).push(t);
            ...
            t.createClass = function(e, n, r) {
                ...
                var i = function() {
                    ...
                    e.apply(t, arguments);
                    for (var n = 0,
                    s = i._reg_; s && n < s.length; n++) s[n].apply(t, arguments)
                };
                return t.extend(i, {
            ...
            function(e) {
                ...
                s = i.prototype;
                return r = new i(r),
                t.forEach(t.number.$Number.prototype,
                function(e, t) {
                    s[t] || (r[t] = e)
                }),
                r
            ...
            t.dom.extend({
                ...
                function(s, o) {
                    ...
                    d = [];
                    if (t.isString(l)) if (!n.test(l)) d.push(o.createTextNode(l));
                    else {
                ...
                addClass: function(e) {
                    ...
                    } else n == "function" && t.forEach(this,
                    function(n, r) {
            ...
            t.dom.extend({
                ...
                append: function() {
                    ...
                    t._util_.smartInsert(this, arguments,
                    function(e) {
                    ...
                    function(t, r) {
                        ...
                        case "string":
                            ...
                            if (!l.test(e) && (o || !c.test(e)) && (u || !h.test(e)) && !v[(d.exec(e) || ["", ""])[1].toLowerCase()]) {
                                e = e.replace(p, "<$1></$2>");
                                try {
                                    t.nodeType === 1 && (f.empty(), t.innerHTML = e),
                                    t = 0
                                } catch(m) {}
                            }
                            t && i.empty().append(e);
                ...
                f;
                for (var l = 0,
                c; c = n[l]; l++) c.nodeType ? u.appendChild(c) : t.forEach(~"string|number".indexOf(t.type(c)) ? t.dom.createElements(c, o) : c,
                function(e) {
                    u.appendChild(e)
                });
            ...
            t.dom.extend({
                clone: function() {
                    ...
                    function a(e, n) {
                        ...
                        case "textarea":
                        case "input":
                            ~"checked|radio".indexOf(e.type) && (e.checked && (n.defaultChecked = n.checked = e.checked), n.value !== e.value && (n.value = e.value)),
                    ...
                    function f(e, i) {
                        ...
                        var s = r.get(e);
                        for (var o in s) for (var u = 0,
                        a; a = s[o][u]; u++) n.add(i, o, a.orig, null, null, a.one)
                    }
                    function l(e, n, r) {
                        var i = e.cloneNode(!0),
                        l,
                    ...
                    o = !0;
                    return ! i.addEventListener && i.attachEvent && i.fireEvent && (i.attachEvent("onclick",
                    function() {
                        o = !1
            ...
            }), t._util_.contains = document.compareDocumentPosition ?
            function(e, t) {
            ...
            t.dom.extend({
                ...
                o = s[0],
                u;
                if (i && o && (!o.parentNode || o.parentNode.nodeType === 11)) i = i === "before",
                u = t.merge(i ? e: s, i ? s: e),
                e !== u && (e.length = 0, t.merge(e, u));
                else for (var a = 0,
                f; f = s[a]; a++) t._util_.smartInsert(t.dom(f), a > 0 ? e.clone(!0, !0) : e, r)
            },
            t.dom.extend({
                appendTo: function(e) {
                    var n = [],
            ...
            !document.createElement("form").enctype && (t._util_.propFixer.enctype = "encoding"), t._util_.prop = function() {
                ...
                function(e, n, r) {
                    ...
                    if (i !== 1 || !t._util_.isXML(e)) n = t._util_.propFixer[n] || n,
                    o = s[n] || {};
                ...
                return e.name = e.id = e.coords = !0,
                {
                    ...
                    set: function(e, t, n) {
                        ...
                        return r || (r = document.createAttribute(t), e.setAttributeNode(r)),
                        r.value = n + ""
                    }
                }
                ...
                return e.support.getSetAttribute || (t.forEach(["width", "height"],
                function(e) {
                    l[e] = {
                        set: function(e, t, n) {
                ...
                s || t.forEach(["href", "src", "width", "height"],
                function(e) {
                    l[e] = {
                        get: function(e, t) {
                ...
                attr: function(e, n) {
                    return t._util_.access(this, e, n,
                    function(e, n, r, i) {
                ...
                children: function(e) {
                    ...
                    return this.each(function() {
                        t.forEach(this.children || this.childNodes,
                        function(e) {
                ...
                getCurrentStyle: function() {
                    var e = document.documentElement.currentStyle ?
                    function(e) {
                ...
                function(s) {
                    ...
                    e["get" + s] = function(e, u) {
                        ...
                        c = "padding|border";
                        return u && t.forEach(u.split("|"),
                        function(e) {~c.indexOf(e) ? c = c.replace(new RegExp("\\|?" + e + "\\|?"), "") : (l += parseFloat(a.getCurrentStyle(e + o[0])) || 0, l += parseFloat(a.getCurrentStyle(e + o[1])) || 0)
                        }),
                        c && t.forEach(c.split("|"),
                        function(e) {
            ...
            document.documentElement.currentStyle ? {
                get: function(e, n) {
                    ...
                    i;
                    return /^-?(?:\d*\.)?\d+(?!px)[^\d\s]+$/i.test(r) && (i = e.style.left, e.style.left = n === "fontSize" ? "1em": r, r = e.style.pixelLeft + "px", e.style.left = i),
                    r
                }
            }: {
                get: function(e, n) {
            ...
            t.string.extend({
                toCamelCase: function() {
                    var e = this.valueOf();
                    return e.indexOf("-") < 0 && e.indexOf("_") < 0 ? e: e.replace(/[-_][^-_]/g,
                    function(e) {
                ...
                data: function() {
                    ...
                    return function(r, i) {
                        ...
                        } else t.type(r) == "object" && t.forEach(this,
                        function(i) {
                            var s = n[i[e]] = n[i[e]] || {};
                            t.forEach(r,
                            function(e, t) {
                ...
                delegate: function(e, t, n, r) {
                    return typeof n == "function" && (r = n, n = null),
                    this.on(t, e, n, r)
                }
            }), t.dom.extend({
                filter: function(e) {
                ...
                remove: function(e, n) {
                    ...
                    for (var i = 0,
                    s; s = r[i]; i++) ! n && s.nodeType === 1 && (t._util_.cleanData(s.getElementsByTagName("*")), t._util_.cleanData([s])),
            ...
            function() {
                ...
                t.event.on(document, "onmousemove",
                function(t) {
                    t = window.event || t,
                    e.x = t.clientX,
                    e.y = t.clientY
                ...
                off: function(e, n, r) {
                    ...
                    s = this;
                    return e ? typeof e == "string" ? (typeof n == "function" && (r = n, n = null), e = e.split(/[ ,]/), t.forEach(this,
                    function(s) {
                        t.forEach(e,
                        function(e) {
                            i.remove(s, e, r, n)
                        })
                    })) : typeof e == "object" && t.forEach(e,
                    function(e, t) {
                        s.off(t, n, e)
                    }) : t.forEach(this,
                    function(e) {
            ...
            function() {
                ...
                function p(c) {
                    ...
                    d = u + p.x - i,
                    v = a + p.y - s;
                    t.isObject(h) && h.length == 4 && (d = Math.max(h[3], d), d = Math.min(h[1] - n.offsetWidth, d), v = Math.max(h[0], v), v = Math.min(h[2] - n.offsetHeight, v)),
                    n.style.left = d + "px",
                    n.style.top = v + "px",
                    f = d,
                    l = v,
                ...
                find: function(e) {
                    ...
                    case "$DOM":
                        n = e.get(),
                        this.each(function() {
                            t.forEach(t.query("*", this),
                            function(e) {
                                for (var t = 0,
                                r = n.length; t < r; t++) e === n[t] && (s[s.length++] = n[t])
                            })
                        })
                    }
            ...
            t.dom.extend({
                ...
                offset: function() {
                    ...
                    return function(n) {
                        ...
                        t._util_.contains(f, s) ? (typeof s.getBoundingClientRect != "undefined" && (u = s.getBoundingClientRect()), a = this.getWindow(), {
            ...
            }), t._util_.getWindowOrDocumentWidthOrHeight = t._util_.getWindowOrDocumentWidthOrHeight ||
            function() {
                var e = {
                    window: {},
                    document: {}
                ...
                height: function(e) {
                    return t._util_.access(this, "height", e,
                    function(e, n, r) {
                        var i = r !== undefined,
                        s = i && parseFloat(r),
            ...
            t.dom.extend({
                hide: function() {
                    ...
                    return this.each(function(s, o) {
                        ...
                        i = o.style.display,
                        e[s] || (r = t._util_.isHidden(o), (i && i !== "none" || !r) && n.data("olddisplay", r ? i: n.getCurrentStyle("display"))),
                ...
                insertHTML: function(e, n) {
                    var r, i, s = this[0];
                    return s.insertAdjacentHTML && !t.browser.opera ? s.insertAdjacentHTML(e, n) : (r = s.ownerDocument.createRange(), e = e.toUpperCase(), e == "AFTERBEGIN" || e == "BEFOREEND" ? (r.selectNodeContents(s), r.collapse(e == "AFTERBEGIN")) : (i = e == "BEFOREBEGIN", r[i ? "setStartBefore": "setEndAfter"](s), r.collapse(i)), r.insertNode(r.createContextualFragment(n))),
                    s
                }
            }), t.dom.extend({
                is: function(e) {
                ...
                parent: function(e) {
                    var n = [];
                    return t.forEach(this,
                    function(e) { (e = e.parentNode) && e.nodeType == 1 && n.push(e)
                    }),
                    this.pushStack(t.dom.match(n, e))
                }
            }), t.dom.extend({
            ...
            function(e, n) {
                ...
                N = function() {
                    ...
                    n = {};
                    for (e in x) x[e] = new RegExp(x[e].source + /(?![^\[]*\])(?![^\(]*\))/.source),
                ...
                O = C(function(e) {
                    ...
                    !e.getElementsByClassName || e.getElementsByClassName("e").length === 0 ? !1 : (e.lastChild.className = "e", e.getElementsByClassName("e").length !== 1)
                }); [0, 0].sort(function() {
                    return l = !1,
                    0
                });
                ...
                _ = function(e, t, n, r, i) {
                    ...
                    if (g.length > 1 && T.exec(e)) if (g.length === 2 && R.relative[g[0]]) o = X(g[0] + g[1], t, r, i);
                    else {
                        o = R.relative[g[0]] ? [t] : M(g.shift(), t);
                        while (g.length) e = g.shift(),
                        R.relative[e] && (e += g.shift()),
                        o = X(e, o, r, i)
                    } else { ! r && g.length > 1 && t.nodeType === 9 && !i && x.ID.test(g[0]) && !x.ID.test(g[g.length - 1]) && (l = j(g.shift(), t, i), t = l.expr ? F(l.expr, l.set)[0] : l.set[0]);
                        if (t) {
                            l = r ? {
                                expr: g.pop(),
                                set: P(r)
                    ...
                    a || (a = o),
                    a || I(c || e);
                    if (u.call(a) === "[object Array]") if (!m) n.push.apply(n, a);
                    else if (t && t.nodeType === 1) for (d = 0; a[d] != null; d++) a[d] && (a[d] === !0 || a[d].nodeType === 1 && B(t, a[d])) && n.push(o[d]);
                    else for (d = 0; a[d] != null; d++) a[d] && a[d].nodeType === 1 && n.push(o[d]);
                    else P(a, n);
                    return f && (_(f, v, n, r, i), H(n)),
                    n
                },
                D = t._util_.isXML,
                P = t.makeArray,
                ...
                R = {
                    ...
                    preFilter: {
                        CLASS: function(e, t, n, r, i, s) {
                            ...
                            if (s) return e;
                            for (var o = 0,
                            u; (u = t[o]) != null; o++) u && (i ^ (u.className && ~ (" " + u.className + " ").replace(E, " ").indexOf(e)) ? n || r.push(u) : n && (t[o] = !1));
                            return ! 1
                        },
                        ID: function(e) {
                ...
                function() {
                    ...
                    _ = function(s, o, u, a, f) {
                        if (!a && !f && (!i || !i.test(s))) if (o.nodeType === 9) try {
                ...
                ready: function() {
                    ...
                    o = function(e) {
                        if (!n) {
                            ...
                            else if (r.addEventListener) r.addEventListener("DOMContentLoaded", s, !1),
                ...
                removeClass: function(e) {
                    var n = typeof e,
                    r = " ";
                    arguments.length || t.forEach(this,
                    function(e) {
                        e.className = ""
                    });
                    if (n == "string") {
                ...
                removeData: function() {
                    ...
                    return function(r) {
                        ...
                        function(i) {
                            var s = n[i[e]];
                            typeof r == "string" ? s && delete s[r] : t.type(r) == "array" && t.forEach(r,
                            function(e) {
                                s && delete s[e]
                            })
                        }),
            ...
            t._util_.getDefaultDisplayValue = function() {
                ...
                return function(n) {
                    ...
                    if (i === "" || i === "none") s = document.body.appendChild(document.createElement("iframe")),
                ...
                toggleClass: function(e, n) {
                    ...
                    arguments.length <= 0 && t.forEach(this,
                    function(e) {
                        e.className = ""
                    });
                    switch (typeof e) {
            ...
            t.dom.extend({
                ...
                width: function(e) {
                    return t._util_.access(this, "width", e,
                    function(e, n, r) {
                        var i = r !== undefined,
                        s = i && parseFloat(r),
                        o = e != null && e == e.window ? "window": e.nodeType === 9 ? "document": !1;
            ...
            t.fx = t.fx || {},
            t.lang.inherits = t.base.inherits, t.fx.Timeline = function(e) {
            ...
            t.lang.inherits(t.fx.Timeline, t.lang.Class, "baidu.fx.Timeline").extend({
                ...
                return i.addEventListener("onbeforestart",
                function() {
                    var e = this,
                    t;
                    ...
                    e.overlapping || ((t = e.element.getAttribute(e.attribName)) && baiduInstance(t).cancel(), e.element.setAttribute(e.attribName, e.guid, 0))
                }),
                i["clean"] = function(e) {
                    var t = this,
                    n;
                    if (e = t.element) e.removeAttribute(t.attribName),
                    n = e.getAttribute(s),
                    n = n.replace("|" + t.guid + "|", ""),
                    n ? e.setAttribute(s, n, 0) : e.removeAttribute(s)
                },
                i.addEventListener("oncancel",
                function() {
                    this["clean"](),
                    this["restore"]()
                }),
                i.addEventListener("onafterfinish",
                function() {
                    this["clean"](),
            ...
            t.fx.current = function(e) {
                ...
                var n, r, i = /\|([^\|]+)\|/g;
                do
                if (r = e.getAttribute("baidu_current_effect")) break;
                while ((e = e.parentNode) && e.nodeType == 1);
                if (!r) return null;
                if (n = r.match(i)) {
                    i = /\|([^\|]+)\|/;
                    for (var s = 0; s < n.length; s++) i.test(n[s]),
            ...
            t.string.extend({
                formatColor: function() {
                    ...
                    return function() {
                        ...
                        if (t.test(r)) {
                            for (var i, s = 1,
                            r = "#"; s < 4; s++) i = parseInt(RegExp["$" + s]).toString(16),
            ...
            t._util_.smartAjax = t._util_.smartAjax ||
            function(e) {
                return function(n, r, i, s) {
                    t.type(r) === "function" && (s = s || i, i = r, r = undefined),
                    t.ajax({
                        type: e,
                        url: n,
                        data: r,
            ...
            t.i18n.cultures["zh-CN"] = t.object.extend(t.i18n.cultures["zh-CN"] || {},
            function() {
                ...
                _basicDate: function(e, n, r) {
                    ...
                    u,
                    a = e.getTime();
                    return n ? (o = t.i18n.cultures[n].timeZone, u = o * 60) : (u = -1 * e.getTimezoneOffset(), o = u / 60),
            ...
            t.object.merge = function() {
                ...
                function n(n, r, i, s, o) {
                    if (r.hasOwnProperty(i)) if (o && e(n[i])) t.object.merge(n[i], r[i], {
                        overwrite: s,
                        recursive: o
                    });
            ...
            function() {
                var e = navigator.userAgent,
                n = function() {};
                return t.forEach("Android iPad iPhone Linux Macintosh Windows X11".split(" "),
                function(r) {
            ...
            t.sio.extend({
                ...
                callByServer: function(e, n) {
                    function v(n) {
                        return function() {
                            try {
                                n ? a.onfailure && a.onfailure() : (e.apply(window, arguments), clearTimeout(h)),
                                window[o] = null,
                                delete window[o]
                            } catch(r) {} finally {
                                t.sio._removeScriptTag(i)
                    ...
                    p = new RegExp("(\\?|&)" + l + "=([^&]*)"),
                    d;
                    if (t.lang.isFunction(e)) o = s + Math.floor(Math.random() * 2147483648).toString(36),
                    window[o] = v(0);
                ...
                format: function(e) {
                    ...
                    return n.length ? (n = n.length == 1 ? e !== null && /\[object Array\]|\[object Object\]/.test(r.call(e)) ? e: n: n, t.replace(/#\{(.+?)\}/g,
                    function(e, t) {
                        var i = n[t];
            ...
            t.swf.version = function() {
                ...
                var v = ["<object "];
                for (o = 0, a = p.length; o < a; o++) f = p[o],
                v.push(" ", f, '="', c(e[f]), '"');
                v.push(">");
                var m = {
                    wmode: 1,
            ...
            t.swf.getMovie = function(e) {
                var n = document[e],
                r;
                return t.browser.ie == 9 ? n && n.length ? (r = t.array.remove(t.lang.toArray(n),
                function(e) {
            ...
            function(e) {
                ...
                t(document).ready(function() {
                    ...
                    typeof n.style.zoom != "undefined" && (n.style.cssText = "padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;width:1px;padding:1px;display:inline;zoom:1", e.inlineBlockNeedsLayout = n.offsetWidth === 3, n.style.display = "block", n.innerHTML = "<div></div>", n.firstChild.style.width = "5px", e.shrinkWrapBlocks = n.offsetWidth !== 3),
                    t.removeChild(r),
                    r = n = t = null
                })
            } (t._util_.support), t
